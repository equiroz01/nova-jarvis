#!/usr/bin/env bash
# ╔══════════════════════════════════════════════════════════════╗
# ║  N.O.V.A. Installer — Mac Home Server Setup                ║
...
echo ""
echo -e "${BOLD}${CYAN}╔══════════════════════════════════════╗${NC}"
echo -e "${BOLD}${CYAN}║       N.O.V.A. INSTALLER v1.0       ║${NC}"
echo -e "${BOLD}${CYAN}╚══════════════════════════════════════╝${NC}"
echo ""
...
# ══════════════════════════════════════════════════════════════
echo ""
echo -e "${BOLD}Configuring N.O.V.A....${NC}"
...
if [[ -f "$ENV_FILE" ]]; then
  ...
  info "Let's configure N.O.V.A. (you can edit $ENV_FILE later)"
  echo ""
  ...
  cat > "$ENV_FILE" <<ENVEOF
# N.O.V.A. Configuration — generated by installer
...
if [[ "$setup_tunnel" == "y" || "$setup_tunnel" == "Y" ]]; then
  ...
  info "Skipping tunnel setup. N.O.V.A. will be LAN-only."
...
# ══════════════════════════════════════════════════════════════
echo ""
echo -e "${BOLD}Starting N.O.V.A....${NC}"
...
echo -e "${BOLD}${GREEN}║      N.O.V.A. INSTALL COMPLETE       ║${NC}"
echo -e "${BOLD}${GREEN}╚══════════════════════════════════════╝${NC}"
echo ""
